...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return { title: dictionary.about.title, description: dictionary.about.intro };
}
...
export default async function AboutPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <main id="main-content">
      ...
      <section className="border-y border-black/10 bg-white py-20 sm:py-28"><div className="site-shell grid gap-14 lg:grid-cols-2"><div className="aspect-[4/3] overflow-hidden bg-[#1d1c19]"><img src="/media/products/rhythm-12/grey.webp" alt="Rhythm 12" width="1000" height="750" className="h-full w-full object-cover" /></div><div className="flex flex-col justify-center"><p className="eyebrow mb-6">02 • {dictionary.about.storyTitle}</p><h2 className="text-4xl leading-tight tracking-[-.04em] sm:text-5xl">{dictionary.about.storyBody}</h2></div></div></section>
